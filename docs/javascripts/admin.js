    ...
    <div class="admin-section">
      ...
      <div class="github-users-section">
        <div class="form-actions" style="margin: 15px 0;">
          ...
          <button onclick="setupGitHubToken()" style="background: #6f42c1; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer; margin-right: 10px;">🔑 设置Token</button>
          <button onclick="debugSyncStatus()" style="background: #ffc107; color: black; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer; margin-right: 10px;">🔍 调试同步</button>
          <button onclick="manualSync()" style="background: #28a745; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer;">🔄 手动同步</button>
        </div>
